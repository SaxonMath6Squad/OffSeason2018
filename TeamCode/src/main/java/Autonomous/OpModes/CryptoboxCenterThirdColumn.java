...
/*
    An opmode to test centering our robot on the farthest column of the cryptobox
 */
@Autonomous(name = "Cryptobox Center Third Column", group = "visual autonomous")
//@Disabled
public class CryptoboxCenterThirdColumn extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        nav.driveDistance(LEFT_COLUMN_DISTANCE_TO_STONE_INCHES,EAST,30,this);
